...
const App = (props) => {
  ...
  const getWeather = async(latitude, longitude) =>{
      const {data} = await axios.get('https://api.openweathermap.org/data/2.5/weather?lat=35.544829899999996&lon=129.3517382&appid=9e0bfa2c5f6975bf6890d7892b8f2c06');
  }
